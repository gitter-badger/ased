	  ...
	  ZPShortcodes: function(editor, url) {
	  	editor.addButton( 'zp_button', {
            ...
            menu: [
                        ...
                        editor.windowManager.open( {
                            ...
                            body: [
							{
								...
								'values': [
									...
									{text: zp_shortcode_label.blog.content.columns.values[2], value: '4'},
                                ]					
							},
							{
								type: 'textbox',
                            ...
                            onsubmit: function( e ) {
								editor.insertContent( '[blog_section columns="'+e.data.columns+'" items="'+e.data.items+'" ][/blog_section]');
                            }
                        });
                    }	
				},
				{ // Buttons
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
								editor.insertContent( '[button class="'+e.data.class+'" size="'+e.data.size+'" inline="'+e.data.inline+'" link="'+e.data.button_link+'" ]'+e.data.button_label+'[/button]');
                            }
                        });
                    }	
				},
				...
				{ // Content Wrapper
					text: zp_shortcode_label.content_wrapper.menu,
                    onclick: function() {
                        editor.windowManager.open( {
                            title: zp_shortcode_label.content_wrapper.header_title,
							minWidth: 500,
							popup_css: false,
							scrollbars: true,
                            body: [
							{
								...
								minWidth: 310,
                                name: 'text',
                                label: zp_shortcode_label.content_wrapper.content.text.label,
								tooltip: zp_shortcode_label.content_wrapper.content.text.tooltip,						
							}
							],
                            onsubmit: function( e ) {
								editor.insertContent( '[content_wrapper]'+e.data.text+'[/content_wrapper]');
                            }
                        });
                    }	
				},
				...
				{ // Fullwidth Slider
					text: zp_shortcode_label.fullwidth_slider.menu,
                    onclick: function() {
                        editor.windowManager.open( {
                            title: zp_shortcode_label.fullwidth_slider.header_title,
							minWidth: 500,
							popup_css: false,
							scrollbars: true,
                            body: [
							{
								...
								minWidth: 310,
                                name: 'slidename',
                                label: zp_shortcode_label.fullwidth_slider.content.slidename.label,
								tooltip: zp_shortcode_label.fullwidth_slider.content.slidename.tooltip					
							},
							{
								type: 'textbox',
								minWidth: 310,
                                name: 'slideshow',
                                label: zp_shortcode_label.fullwidth_slider.content.slideshow.label,
								tooltip: zp_shortcode_label.fullwidth_slider.content.slideshow.tooltip					
							},
							{
								type: 'listbox',
								minWidth: 310,
                                name: 'effect',
                                label: zp_shortcode_label.fullwidth_slider.content.effect.label,
								tooltip: zp_shortcode_label.fullwidth_slider.content.effect.tooltip,
								'values': [
                                    {text: zp_shortcode_label.fullwidth_slider.content.effect.values[0], value: 'fade'},
                                    {text: zp_shortcode_label.fullwidth_slider.content.effect.values[1], value: 'slide'},
                                ]					
							}
							],
                            onsubmit: function( e ) {
								editor.insertContent( '[fullwidth_slider slidename="'+e.data.slidename+'" slideshow="'+e.data.slideshow+'"  effect="'+e.data.effect+'"]');
                            }
                        });
                    }	
				},
				...
				{ // Map Shortcode
                    text: zp_shortcode_label.map_shortcode.menu,
                    onclick: function() {
                        editor.windowManager.open( {
                            title: zp_shortcode_label.map_shortcode.header_title,
							minWidth: 500,
							popup_css: false,
                            body: [
							{
                                type: 'textbox',
                                name: 'content',
                                label: zp_shortcode_label.map_shortcode.content.map_iframe.label,
								multiline: true,
								minHeight: 100,
								minWidth: 310,
								tooltip: zp_shortcode_label.map_shortcode.content.map_iframe.tooltip
                            },
							{
								type: 'textbox',
                                name: 'frame_height',
                                label: zp_shortcode_label.map_shortcode.content.frame_height.label,
								tooltip: zp_shortcode_label.map_shortcode.content.frame_height.tooltip,
								minWidth: 310,
							}],
                            onsubmit: function( e ) {
								editor.insertContent( '[map_section frame_height="'+e.data.frame_height+'"]'+e.data.map_iframe+'[/map_section]');
                            }
                        });
                    }
                },
				...
				{ // Pricing Shortcode
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
								editor.insertContent( '[pricing columns="'+e.data.columns+'" ids="" ][/pricing]');
                            }
                        });
                    }	
				},
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            body: [
							{
								...
								minWidth: 310,
                                name: 'columns',
                                label: zp_shortcode_label.portfolio.content.columns.label,
								tooltip: zp_shortcode_label.portfolio.content.columns.tooltip,
								'values': [
                                    {text: zp_shortcode_label.portfolio.content.columns.values[0], value: '2'},
                                    {text: zp_shortcode_label.portfolio.content.columns.values[1], value: '3'},
									{text: zp_shortcode_label.portfolio.content.columns.values[2], value: '4'},
                                ]					
							},
							{
								type: 'textbox',
				...
				{ // Service
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
								editor.insertContent( '[services columns="'+e.data.columns+'" align="'+e.data.align+'" items="'+e.data.items+'" ids="" ]');
                            }
                        });
                    }	
				},
				...
				{ // Team Shortcode
                    ...
                    onclick: function() {
                        editor.windowManager.open( {
                            ...
                            onsubmit: function( e ) {
								editor.insertContent( '[team columns="'+e.data.columns+'" align="'+e.data.align+'" ids="" ][/team]');
                            }
                        });
                    }	
				},
				{ // Testimonial Shortcode
                    ...
                    onclick: function() {
						editor.insertContent( '[testimonial_section ids="" ][/testimonial_section]');
                    }	
				},
				{ // Tooltip
